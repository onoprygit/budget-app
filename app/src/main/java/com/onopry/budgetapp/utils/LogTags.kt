...
object MY_COLORS{
    ...
    val color_category_3 = Color.parseColor("#FFCB7C")
    val color_category_4 = Color.parseColor("#CE97DB")
    val color_category_5 = Color.parseColor("#F28CB4")
    val color_category_6 = Color.parseColor("#B89AD5")
    val color_category_7 = Color.parseColor("#8FC5F8")
    val color_category_8 = Color.parseColor("#FAE285")
    val color_category_9 = Color.parseColor("#F8A693")
